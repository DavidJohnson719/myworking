    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_review:{
                Intent intent  = new Intent( DeliveryDetailActivity.this, RateActivity.class );
                startActivity( intent );
                break;
            }
            case  R.id.txt_cart:{
                Intent intent  = new Intent( DeliveryDetailActivity.this, DeliveryPaymentActivity.class );
                startActivity( intent );
                break;
            }
            ...
            case R.id.delivery_rate: {
                Intent intent = new Intent( DeliveryDetailActivity.this, OrderSummaryActivity.class );
                startActivity( intent );
                break;
            }
            default:
...
// section 2
            ...
            if (item.type == Item.SECTION) {
                ...
                btn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        flag = !flag;
                        map.put("extend", flag );
                        DeliveryDetailActivity main  = (DeliveryDetailActivity) mCtx;
    ...
    protected void onResume() {
        ...
        if ( MainActivity.global.nSelectedNum > 3 )
        {
    ...
    public void gotoPayment()
    {
        Intent intent  = new Intent( DeliveryDetailActivity.this, DeliveryPaymentActivity.class );
        startActivity( intent );
        MainActivity.global.nSelectedNum ++;
        if ( MainActivity.global.nSelectedNum > 3 )
        {
            lvTotal.setVisibility( View.VISIBLE );
            lvAdditional.setVisibility( View.GONE );
